    ...
    const footerGroup = (
        <ColumnGroup>
            ...
            <Row>
                <Column
                    footer={
                        <div className="flex align-items-center justify-content-end">
                            <Checkbox inputId="includeVAT" checked={includeVAT} onChange={(e) => setIncludeVAT(e.checked)} />
                            <label htmlFor="includeVAT" className="ml-2">VAT 10%:</label>
                        </div>
                    }
                    colSpan={4}
                    align="right"
                ...
                />
                <Column footer="ລວມເງິນທັງໝົດ" colSpan={2} align="right" className="text-lg font-bold" />
                <Column footer={formatNumber(total)} align="right" className="text-lg font-bold" />
                <Column footer={null} />
                <Column footer={null} />
            </Row>
            <Row>
            ...
            <div className="col-12">
                ...
                <div className="card mb-3 pb-0">
                    <div className="p-fluid formgrid grid">
                        ...
                        <div className="field col-4">
                            <label htmlFor="description">ລາຍລະອຽດ/ຈຸດປະສົງ</label>
                            <InputText id="description" type="text" />
                        </div>
                        <div className="field col-4">
                            <label htmlFor="description">ອີງຕາມເອກະສານ...(ຖ້າມີ)</label>
                            <InputText id="description" type="text" />
                        </div>
                    </div>
                </div>
                ...
                <div className="grid">
                    <div className="col-12 md:col-3">
                        <Fieldset legend="ປ້ອນຂໍ້ມູນການຂໍຊື້" className="h-full" toggleable>
                            <div className="p-fluid formgrid grid">
                    ...
                    <div className="col-12 md:col-9">
                        <Fieldset legend="ລາຍການຂໍຊື້" className="h-full" toggleable>
