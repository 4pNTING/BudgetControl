    ...
    return (
        <>
            <div className="flex h-screen">
                ...
                <div className="w-8 hidden lg:flex flex-column justify-content-between align-items-center px-6 py-6 bg-cover bg-norepeat" style={{ backgroundImage: "url('/images/auth/bg-login.jpg')" }}>
